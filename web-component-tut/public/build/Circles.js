...
(function () {
    ...
    // (28:2) {#each datasetArray as d, i (d.x)}
    function create_each_block(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			add_location(circle, file, 28, 4, 966);
    			this.first = circle;
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(28:2) {#each datasetArray as d, i (d.x)}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			this.c = noop;
    			add_location(svg, file, 26, 0, 919);
    		},
    ...
    class Circles extends SvelteElement {
    	constructor(options) {
    		...
    		if (/*my_dataset*/ ctx[2] === undefined && !('my_dataset' in props)) {
    			console_1.warn("<undefined> was created without expected prop 'my_dataset'");
    		}
